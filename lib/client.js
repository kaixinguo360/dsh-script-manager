...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var css = [
			...
			".smp-ovl-body{flex:1;overflow-y:auto;padding:10px 14px;display:flex;flex-direction:column;gap:10px;min-height:0}",
			...
			".smp-ovl-history-list{display:flex;flex-direction:column;gap:6px;flex:1;overflow-y:auto;min-height:0}",
			".smp-ovl-history-empty{font-size:12px;color:var(--dsw-alias-label-tertiary);padding:12px 0;text-align:center;flex:none}",
			".smp-ovl-history-item{border:1px solid var(--dsw-alias-border-l2);border-radius:8px;overflow:hidden;flex:none}",
